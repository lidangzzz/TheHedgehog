...
function inverse(inmat) {
  ...
  var B = new _matrix.mat().identity(inmat.rows).val;
  var cols = inmat.cols;
  var rows = inmat.rows; // loop over all columns, and perform row reductions

  for (var c = 0; function (_left3, _right3) {
