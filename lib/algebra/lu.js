...
function LU(m_) {
  ...
  var U = new mat().zeros(n, cols); // permutation vector
  ...
  for (var j = 0; function (_left2, _right2) {
    ...
    for (var i = j; function (_left7, _right7) {
    ...
    if (function (_left10, _right10) {
      ...
      for (var i = function (_left11, _right11) {
        ...
        if (function (_left13, _right13) {
          ...
          m.val[i][j] = function (_left14, _right14) {
  ...
  for (var i = 0, n = p.length; function (_left27, _right27) {
