...
function _iterableToArray(iter) { if (function (_left83, _right83) { if (_left83 !== null && _left83 !== undefined && _left83[Symbol.for("in")]) return _left83[Symbol.for("in")](_right83);else return _left83 in _right83; }(Symbol.iterator, Object(iter)) || function (_left84, _right84) { if (_left84 !== null && _left84 !== undefined && _left84[Symbol.for("===")]) return _left84[Symbol.for("===")](_right84);else return _left84 === _right84; }(Object.prototype.toString.call(iter), "[object Arguments]")) return Array.from(iter); }

function _arrayWithoutHoles(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = new Array(arr.length); function (_left82, _right82) { if (_left82 !== null && _left82 !== undefined && _left82[Symbol.for("<")]) return _left82[Symbol.for("<")](_right82);else return _left82 < _right82; }(i, arr.length); i++) { arr2[i] = arr[i]; } return arr2; } }

function _classCallCheck(instance, Constructor) { if (!function (_left81, _right81) { if (_left81 !== null && _left81 !== undefined && _left81[Symbol.for("instanceof")]) return _left81[Symbol.for("instanceof")](_right81);else return _left81 instanceof _right81; }(instance, Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function _defineProperties(target, props) { for (var i = 0; function (_left79, _right79) { if (_left79 !== null && _left79 !== undefined && _left79[Symbol.for("<")]) return _left79[Symbol.for("<")](_right79);else return _left79 < _right79; }(i, props.length); i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (function (_left80, _right80) { if (_left80 !== null && _left80 !== undefined && _left80[Symbol.for("in")]) return _left80[Symbol.for("in")](_right80);else return _left80 in _right80; }("value", descriptor)) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }

var op = new _operator.op();
...
function () {
  ...
  _createClass(mat, [{
    ...
    value: function col(colIndex) {
      ...
      for (var rowPt = 0; function (_left52, _right52) {
