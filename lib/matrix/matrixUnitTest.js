...
function matrixOperationTest() {
  ...
  assert(m1.divs(2).equals(new mat().range(1, 10).reshape(3, 3)), msg); //console.log(new mat().range(1, 10).reshape(2, 4).median());
  ...
  }(new mat().range(1, 10).reshape(2, 4).median(), 4.5), msg);
}
