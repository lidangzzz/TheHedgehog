...
const gpu = new gpu_(); //leftMatrix + rightMatrix, save the result into left matrix
...
function mul(leftMat, rightMat) {
  ...
  for (var i = 0; function (_left10, _right10) {
    ...
    for (var j = 0; function (_left11, _right11) {
      ...
      }(it, n); it++) val += function (_left13, _right13) {
...
function mul_gpu(leftMat, rightMat) {
  ...
  const mulfunction_string = function (_left18, _right18) {
...
function x_mul_xT(inMat) {
  ...
  const mulfunction_string = function (_left20, _right20) {
...
function xT_mul_x(inMat) {
  ...
  const mulfunction_string = function (_left22, _right22) {
