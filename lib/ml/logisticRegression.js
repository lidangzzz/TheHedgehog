...
function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (function (_left33, _right33) { if (_left33 !== null && _left33 !== undefined && _left33[Symbol.for("!=")]) return _left33[Symbol.for("!=")](_right33);else return _left33 != _right33; }(obj, null)) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) { var desc = Object.defineProperty && Object.getOwnPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : {}; if (desc.get || desc.set) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } } newObj.default = obj; return newObj; } }
...
function () {
  ...
  _createClass(LogisticRegression, [{
    ...
    value: function predict(x_) {
      ...
      var x_test = x_norm.resize(x_norm.rows, function (_left13, _right13) {
      ...
      }("testing x ", x_test)); //calculate the output matrix of y

      var y_predict = function (_left15, _right15) {
        if (_left15 !== null && _left15 !== undefined && _left15[Symbol.for("*")]) return _left15[Symbol.for("*")](_right15);else return _left15 * _right15;
      }(x_test, this.weight);

      console.log(function (_left16, _right16) {
      ...
      console.log(function (_left17, _right17) {
